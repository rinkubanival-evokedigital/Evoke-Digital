...
export default function LogoSlider() {
  ...
  return (
    <div className="relative overflow-hidden py-12 bg-white whitespace-nowrap">
      ...
      >
        <img src="/logo/logo1.png" className="h-40 w-40 mx-10 inline-block" />
        <img src="/logo/logo2.png" className="h-40 w-40 mx-10 inline-block" />
        <img src="/logo/logo3.png" className="h-40 w-40 mx-10 inline-block" />          
        <img src="/logo/logo4.png" className="h-40 w-40 mx-10 inline-block" />
        <img src="/logo/logo5.png" className="h-40 w-40 mx-10 inline-block" />
        <img src="/logo/logo1.png" className="h-40 w-40 mx-10 inline-block" />
        <img src="/logo/logo2.png" className="h-40 w-40 mx-10 inline-block" />
        <img src="/logo/logo3.png" className="h-40 w-40 mx-10 inline-block" />          
        <img src="/logo/logo4.png" className="h-40 w-40 mx-10 inline-block" />
