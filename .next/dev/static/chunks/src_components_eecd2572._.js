...
"[project]/src/components/Textvd.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OceanHeader() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: "relative mx-auto max-w-[1200px] w-full m-8 bg-white",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("source", {
                        ...
                        fileName: "[project]/src/components/Textvd.jsx",
                        lineNumber: 28,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("source", {
...
_s(OceanHeader, "PdMsmLAy5JKU3vCrhAlqGYQfKuA=");
_c = OceanHeader;
var _c;
__turbopack_context__.k.register(_c, "OceanHeader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/Videovd.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VideoShaderCanvas() {
    _s();
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const videoRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const reglRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const animationStartedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const mouseLocation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([
        -1,
        -1
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoShaderCanvas.useEffect": ()=>{
            let mounted = true;
            let startupAttempt = 0;
            let startButton = null;
            // dynamic import of regl to avoid SSR issues
            const setup = {
                "VideoShaderCanvas.useEffect.setup": async ()=>{
                    const reglModule = await __turbopack_context__.A("[project]/node_modules/regl/dist/regl.js [app-client] (ecmascript, async loader)");
                    const createREGL = reglModule.default || reglModule;
                    if (!mounted) return;
                    const canvas = canvasRef.current;
                    const elVideo = videoRef.current;
                    const setFullSize = {
                        "VideoShaderCanvas.useEffect.setup.setFullSize": (el)=>{
                            if (!el) return;
                            el.width = window.innerWidth * PIXEL_DENSITY;
                            el.height = window.innerHeight * PIXEL_DENSITY;
                        }
                    }["VideoShaderCanvas.useEffect.setup.setFullSize"];
                    const keepFullSize = {
                        "VideoShaderCanvas.useEffect.setup.keepFullSize": (el)=>{
                            window.addEventListener('resize', {
                                "VideoShaderCanvas.useEffect.setup.keepFullSize": ()=>setFullSize(el)
                            }["VideoShaderCanvas.useEffect.setup.keepFullSize"]);
                            setFullSize(el);
                        }
                    }["VideoShaderCanvas.useEffect.setup.keepFullSize"];
                    keepFullSize(canvas);
                    ...
                    function initShader() {
                        ...
                        const drawFrame = regl({
                            ...
                            uniforms: {
                                resolution: {
                                    "VideoShaderCanvas.useEffect.setup.initShader.drawFrame": ({ viewportWidth, viewportHeight })=>[
                                            viewportWidth,
                                            viewportHeight
                                        ]
                                }["VideoShaderCanvas.useEffect.setup.initShader.drawFrame"],
                                time: regl.context('time'),
                                timeDelta: regl.context('deltaTime'),
                                mouseLoc: {
                                    "VideoShaderCanvas.useEffect.setup.initShader.drawFrame": ()=>mouseLocation.current
                                }["VideoShaderCanvas.useEffect.setup.initShader.drawFrame"],
                                txVideo: {
                                    "VideoShaderCanvas.useEffect.setup.initShader.drawFrame": ()=>textureRef.current
                                }["VideoShaderCanvas.useEffect.setup.initShader.drawFrame"],
                                videoResolution: [
                                    960,
                                    400
                                ...
                                videoProgress: {
                                    "VideoShaderCanvas.useEffect.setup.initShader.drawFrame": ()=>elVideo.duration ? elVideo.currentTime / elVideo.duration : 0.0
                                }["VideoShaderCanvas.useEffect.setup.initShader.drawFrame"]
                            }
                        });
                        regl.frame({
                            "VideoShaderCanvas.useEffect.setup.initShader": ()=>{
                                regl.clear({
                                    color: [
                                        0,
                                        0,
                    ...
                    function tryStart() {
                        if (elVideo.readyState >= HTMLMediaElement.HAVE_FUTURE_DATA) {
                            ...
                            elVideo.play().catch({
                                "VideoShaderCanvas.useEffect.setup.tryStart": ()=>{}
                            }["VideoShaderCanvas.useEffect.setup.tryStart"]);
                            initShader();
                        } else {
                            startupAttempt += 1;
                    ...
                    const onMouseMove = {
                        "VideoShaderCanvas.useEffect.setup.onMouseMove": (evt)=>{
                    ...
                    }["VideoShaderCanvas.useEffect.setup.onMouseMove"];
                    const onClick = {
                        "VideoShaderCanvas.useEffect.setup.onClick": (evt)=>{
                            const bounds = canvas.getBoundingClientRect();
                    ...
                    }["VideoShaderCanvas.useEffect.setup.onClick"];
                    ...
                    // cleanup on unmount
                    return ({
                        "VideoShaderCanvas.useEffect.setup": ()=>{
                            mounted = false;
            ...
            return ({
                "VideoShaderCanvas.useEffect": ()=>{
                    ...
                    cleanupPromise.then({
                        "VideoShaderCanvas.useEffect": (cleanup)=>{
                            if (typeof cleanup === 'function') cleanup();
                        }
                    }["VideoShaderCanvas.useEffect"]).catch({
                        "VideoShaderCanvas.useEffect": ()=>{}
                    }["VideoShaderCanvas.useEffect"]);
                }
            })["VideoShaderCanvas.useEffect"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative w-full h-screen bg-[#121318] overflow-hidden",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                ref: videoRef,
                id: "video",
                ...
                fileName: "[project]/src/components/Videovd.jsx",
                lineNumber: 325,
                columnNumber: 7
            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute left-4 top-4 z-40 text-sm text-gray-300"
            }, void 0, false, {
                fileName: "[project]/src/components/Videovd.jsx",
                lineNumber: 343,
                columnNumber: 7
...
_s(VideoShaderCanvas, "BWSHS4H2+C/r2nkMmTFLMKKVG3U=");
_c = VideoShaderCanvas;
var _c;
__turbopack_context__.k.register(_c, "VideoShaderCanvas");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_components_eecd2572._.js.map